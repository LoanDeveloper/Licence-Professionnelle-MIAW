    ...
    <div class="w3-col m4 w3-margin-bottom">
      <div class="w3-light-grey">
        ...
        <div class="w3-container">
          ...
          <p>On trouve de plus en plus de mobilier en rotin, qui était déjà bien présent, me direz-vous [ Voir ou revoir [ Tendance déco ] Le rotin, stop ou encore ? ], mais dans des teintes naturelles.</p>
        </div>
      </div>
    </div>
    ...
    <div class="w3-col m4 w3-margin-bottom">
      <div class="w3-light-grey">
        ...
        <div class="w3-container">
          ...
          <p>Le vintage est tendance depuis déjà une bonne dizaine d’année et plus. Les marques comme Urban Outfitters n’en finissent pas de surfer sur la vague. </p>
        </div>
      </div>
    </div>
    ...
    <div class="w3-col m4 w3-margin-bottom">
      <div class="w3-light-grey">
        ...
        <div class="w3-container">
          ...
          <p>Hello, hello les Amoureux de la déco,Je suis tombée dernièrement sur deux mises en scène réalisées par deux grandes maques de la grande distribution, j’ai nommé Zara Home et Ikea.</p>
        </div>
      </div>
    </div>
